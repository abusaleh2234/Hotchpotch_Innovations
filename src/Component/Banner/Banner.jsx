...
const Banner = () => {
    return (
        <div className="h- md:min-h-[90vh] bg-[#12141D] flex justify-center py-7">
            <div className="content-center text-center space-y-4 md:space-y-9">
                <div className="">
                ...
                <p className="text-[#B7B8BB] text-base sm:text-lg max-w-[300px] md:max-w-[500px] mx-auto">Artificial intelligence writting tool helps you create blogs, social media websites and much more.</p>
