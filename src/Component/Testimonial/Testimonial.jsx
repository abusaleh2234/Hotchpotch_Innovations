                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
                        <div className="space-y-4 lg:space-y-6">
                            ...
                            <div className="bg-[#FFFFFF] py-6 px-5 rounded-md">
                                <div className="flex justify-between pb-5">
                                    <div className="flex items-center gap-3">
                                        <img src={User5} className="w-11 h-11 rounded-full" alt="" />
                                        <div className="">
                        ...
                        <div className="space-y-4 lg:space-y-6">
                            <div className="bg-[#FFFFFF] py-6 px-5 rounded-md">
                                <div className="flex justify-between pb-5">
                                    <div className="flex items-center gap-3">
                                        <img src={User2} className="w-11 h-11 rounded-full" alt="" />
                                        <div className="">
                            ...
                            <div className="bg-[#FFFFFF] py-6 px-5 rounded-md">
                                <div className="flex justify-between pb-5">
                                    <div className="flex items-center gap-3">
                                        <img src={User6} className="w-11 h-11 rounded-full" alt="" />
                                        <div className="">
                        ...
                        <div className="space-y-4 lg:space-y-6">
                            <div className="bg-[#FFFFFF] py-6 px-5 rounded-md">
                                <div className="flex justify-between pb-5">
                                    <div className="flex items-center gap-3">
                                        <img src={User3} className="w-11 h-11 rounded-full" alt="" />
                                        <div className="">
                            ...
                            <div className="bg-[#FFFFFF] py-6 px-5 rounded-md">
                                <div className="flex justify-between pb-5">
                                    <div className="flex items-center gap-3">
                                        <img src={User7} className="w-11 h-11 rounded-full" alt="" />
                                        <div className="">
                        ...
                        <div className="space-y-4 lg:space-y-6">
                            <div className="bg-[#FFFFFF] py-6 px-5 rounded-md">
                                <div className="flex justify-between pb-5">
                                    <div className="flex items-center gap-3">
                                        <img src={User4} className="w-11 h-11 rounded-full" alt="" />
                                        <div className="">
                            ...
                            <div className="bg-[#FFFFFF] py-6 px-5 rounded-md">
                                <div className="flex justify-between pb-5">
                                    <div className="flex items-center gap-3">
                                        <img src={User8} className="w-11 h-11 rounded-full" alt="" />
                                        <div className="">
